                ...
                <div className="row">
                    <div className="col">
                        <Link to='https://music.163.com/#/user/home?id=1461871511'>
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="black" className="bi bi-music-note ms-4 cloud" viewBox="0 0 16 16">
                    ...
                    <div className="col">
                        <Link to='https://github.com/Yan-huimin'>
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="black" className="bi bi-github ms-4 git" viewBox="0 0 16 16">
                    ...
                    <div className="col">
                        <Link to='https://im.qq.com/index/'>
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="black" className="bi bi-tencent-qq ms-4 qq" viewBox="0 0 16 16">
                    ...
                    <div className="col">
                        <Link to='https://space.bilibili.com/3461575734200583?spm_id_from=333.1007.0.0'>
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="black" className="bi bi-bootstrap ms-4 bili" viewBox="0 0 16 16">
